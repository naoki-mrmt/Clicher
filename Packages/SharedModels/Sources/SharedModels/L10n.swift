...
public enum L10n {
    ...
    public static var recordingComplete: String { localized(ja: "録画完了", en: "Recording Complete") }
    public static var revealInFinder: String { localized(ja: "Finderで表示", en: "Reveal") }
